...
//  DesignCode
//
//  Created by MANAS VIJAYWARGIYA on 28/07/20.
            ...
            .background(
                ZStack {
                    ...
                    RoundedRectangle(cornerRadius: 16, style: .continuous)
                        ...
                        .offset(x:-8,y:-8)
                    RoundedRectangle(cornerRadius: 16, style: .continuous)
                        //.foregroundColor(Color(#colorLiteral(red: 0.8140416744, green: 0.8766303775, blue: 1, alpha: 1)))
                        .fill(
            ...
            .overlay(
                HStack {
                    Image(systemName: "person.crop.circle")
                        ...
                        .foregroundColor(Color(#colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)).opacity(press ? 0 : 1))
...
struct PayButton: View {
    ...
    var body: some View {
        ...
        .background(
            ...
            .scaleEffect(tap ? 1.2 : 1)
            .gesture(
                LongPressGesture(minimumDuration: 0.5, maximumDistance: 10).updating($tap) {currentState, gestureState, transaction in
